...
AShooterBarricade_Health::AShooterBarricade_Health(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	Health = 50;
}

bool AShooterBarricade_Health::CanBePickedUp(class AShooterCharacter* TestPawn) const
{
	return TestPawn && (TestPawn->Health < TestPawn->GetMaxHealth());
}

void AShooterBarricade_Health::GiveBarricadeTo(class AShooterCharacter* Pawn)
{
	if (Pawn)
	{
