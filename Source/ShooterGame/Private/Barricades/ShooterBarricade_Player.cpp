...
AShooterBarricade_Ammo::AShooterBarricade_Ammo(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	AmmoClips = 2;
}

bool AShooterBarricade_Ammo::IsForWeapon(UClass* WeaponClass)
{
	return WeaponType->IsChildOf(WeaponClass);
}

bool AShooterBarricade_Ammo::CanBePickedUp(AShooterCharacter* TestPawn) const
{
...
void AShooterBarricade_Ammo::GiveBarricadeTo(class AShooterCharacter* Pawn)
{
