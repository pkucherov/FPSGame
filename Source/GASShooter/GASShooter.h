...
#define COLLISION_ABILITY						ECollisionChannel::ECC_GameTraceChannel5
#define COLLISION_GASPROJECTILE					ECollisionChannel::ECC_GameTraceChannel6
#define COLLISION_ABILITYOVERLAPPROJECTILE		ECollisionChannel::ECC_GameTraceChannel7
#define COLLISION_GASPICKUP						ECollisionChannel::ECC_GameTraceChannel8
#define COLLISION_INTERACTABLE					ECollisionChannel::ECC_GameTraceChannel9
